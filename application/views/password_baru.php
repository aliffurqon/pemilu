...
<body>
    ...
    <div class="contact-clean">
        ...
        <?php endif; ?>
        <form action="<?php echo base_url() ?>index.php/Reset_password/reset_password_validation" method="post">
            <h2 class="text-center">GANTI PASSWORD</h2>
            <input class="form-control" type="hidden" name="nik" value="<?php echo $this->session->userdata("nik")?>">
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Masukkan Password baru anda"></div>
            <div class="form-group"><input class="form-control" type="password" name="retype_password" placeholder="Konfirmasi ulang Password baru anda"></div>
